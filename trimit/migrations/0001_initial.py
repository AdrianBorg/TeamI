# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2019-02-28 19:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(default=models.SET(trimit.models.deleted_user), on_delete=models.SET(trimit.models.deleted_user), to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
