...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='page',
            name='specialities',
            field=tagulous.models.fields.TagField(_set_tag_meta=True, autocomplete_limit=8, blank=True, force_lowercase=True, help_text='Enter a comma-separated tag string', space_delimiter=False, to='trimit.Specialities', verbose_name_plural='Specialities', verbose_name_singular='Speciality'),
        ),
        migrations.AddField(
            model_name='page',
            name='user',
