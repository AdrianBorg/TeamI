# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2019-03-13 18:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('overall_rating', models.DecimalField(decimal_places=1, default=0, max_digits=3, null=True)),
                ('mean_atmosphere_rating', models.DecimalField(decimal_places=1, max_digits=10, null=True)),
                ('mean_price_rating', models.DecimalField(decimal_places=1, max_digits=10, null=True)),
                ('mean_service_rating', models.DecimalField(decimal_places=1, max_digits=10, null=True)),
                ('number_of_reviews', models.DecimalField(decimal_places=0, default=0, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('average_rating', models.DecimalField(blank=True, decimal_places=1, max_digits=10, null=True)),
                ('atmosphere_rating', models.DecimalField(decimal_places=1, max_digits=10)),
                ('price_rating', models.DecimalField(decimal_places=1, max_digits=10)),
                ('service_rating', models.DecimalField(decimal_places=1, max_digits=10)),
